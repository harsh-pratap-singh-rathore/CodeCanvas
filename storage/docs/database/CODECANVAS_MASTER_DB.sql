-- ============================================
-- CODECANVAS MASTER DATABASE BUILD SCRIPT
-- ============================================
-- This script builds the complete database for CodeCanvas,
-- including all tables, columns, and initial data identified
-- from the codebase.
-- ============================================
-- INSTRUCTIONS:
